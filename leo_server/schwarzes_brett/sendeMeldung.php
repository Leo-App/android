...
?>
	<html>
		<h2>
			<font face="Comic Sans Ms">Ihre Angaben waren nicht vollständig, bitte gehen Sie zurück und füllen Sie alle Felder aus</font>
		</h2>
		<br>
		<form>
...
?>
	<html>
		<p>
			<font face="Comic Sans Ms">Der Eintrag wurde erfolgreich gespeichert!</font>
		</p>
		<br>
		<form>
			<input type="button" value="Zurück" onclick="window.location.href='http://moritz.liegmanns.de/schwarzes_brett/NeueMeldung.php'" />
