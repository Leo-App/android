...
public class OverviewWrapper extends AppCompatActivity {
    ...
    public boolean userDome = false, chatsDone = false;
    ...
    public Chat findChat(int u1, int u2) {
        String cname1 = u1 + " - " + u2, cname2 = u2 + " - " + u1;
        for (Chat c : chatArray) {
            if (c.chatName.equals(cname1) || c.chatName.equals(cname2))
                return c;
        }
        return null;
    }
