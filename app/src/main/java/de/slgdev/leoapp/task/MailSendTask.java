...
public class MailSendTask extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... strings) {
        ...
        try {
            ...
            MailClient mailClient = new MailClient(new List<String>().append("app@leo-ac.de"), "FeatureRequest - " + Utils.getUserDefaultName() + " - " + Utils.getUserStufe() + " - " + Utils.getAppVersionName(), emailBody);
